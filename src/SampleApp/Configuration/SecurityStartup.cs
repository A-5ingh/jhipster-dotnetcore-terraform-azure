...
using SampleApp.Security.Jwt;
using SampleApp.Domain.Services;
using SampleApp.Domain.Services.Interfaces;
...
using AuthenticationService = SampleApp.Domain.Services.AuthenticationService;
using IAuthenticationService = SampleApp.Domain.Services.Interfaces.IAuthenticationService;
