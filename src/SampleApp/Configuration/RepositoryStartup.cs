...
using SampleApp.Domain.Repositories.Interfaces;
using SampleApp.Infrastructure.Data.Repositories;
        ...
        public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
        {
            ...
            services.Scan(scan => scan
                .FromAssembliesOf(typeof(IUnitOfWork), typeof(UnitOfWork))
                    ...
                    .AddClasses(classes => classes.InNamespaces("SampleApp.Infrastructure.Data.Repositories"))
                    ...
                    .AddClasses(classes => classes.Where(type => type.Namespace.Equals("SampleApp.Infrastructure.Data.Repositories") &&
